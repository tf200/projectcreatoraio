...
| **2026-09-11** | Phase 8: 2-Pane Split Chat UI | Upgraded direct chat UI in `ProjectNotesList.vue` from card-grid/screen-swapping to a 2-pane split view with a persistent left member list and right conversation feed. Added member search/filter and responsive mobile support. | Completed |
